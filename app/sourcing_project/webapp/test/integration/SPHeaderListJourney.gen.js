...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("SPHeaderListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheSPHeaderListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheSPHeaderListGenerated.onFilterBar().iChangeSearchField("Search Term");
        //     When.onTheSPHeaderListGenerated.onFilterBar().iExecuteSearch();
        //     Then.onTheSPHeaderListGenerated.onTable().iCheckRows();
        // });
        ...
        opaTest("Navigate to ObjectPage", function (Given, When, Then) {
            ...
            When.onTheSPHeaderListGenerated.onTable().iPressRow(0);
            Then.onTheSPHeaderObjectPageGenerated.iSeeThisPage();
