...
sap.ui.define([
    ...
    function journey() {
        QUnit.module("DocumentsListListReport journey");

        opaTest("Start application", function (Given, When, Then) {
            Given.iStartMyApp();

            Then.onTheDocumentsListGenerated.iSeeThisPage();
        });
        ...
        //     When.onTheDocumentsListGenerated.onFilterBar().iChangeSearchField("Search Term");
